...
async function apiRequest(){
    const alienName = document.querySelector('input').value.toLowerCase() || `humans`
    try{
        const response = await fetch(`https://star-trek-api-tehuberjohn.herokuapp.com/api/${alienName}`)
